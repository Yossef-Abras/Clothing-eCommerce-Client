    ...
    <Card className="shadow-lg m-4 md:m-10 md:w-[700px] w-[300px] md:max-h-[275px] max-h-[475px] md:h-[275px] h-[475px]">
      <div className="flex flex-col pb-3">
        <div className="flex flex-col md:flex-row w-full">
          <div className="flex bg-primary text-white rounded-b-full md:w-24 w-full h-14 md:h-20 justify-center mx-auto md:mx-4 font-bold">
            ...
            <div className="w-full self-center px-0 md:w-2/3">
              ...
              <div className="flex justify-center items-center flex-wrap md:px-0 px-4 gap-1 mt-4 h-[100px]">
                {categories.map((category) => (
                  <Link
                    key={category._id}
                    className="border-2 rounded-2xl border-primary text-primary px-2 py-1 mb-[3px] hover:bg-primary hover:text-white"
