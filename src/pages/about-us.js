  ...
  return (
    <div>
      <div className="relative">
        <div className="flex flex-wrap min-h-screen">
          <div className="w-[50%] hidden md:block">
            <img className="max-w-full h-full object-cover" src="/img/cloth1.webp" />
          </div>
      ...
      <div class="w-[530px] max-w-full mx-auto my-12 relative">
        <div>
          <img className="max-w-full" src="/img/cloth2.webp" />
        </div>
      ...
      <div class="relative">
        <div class="flex flex-wrap min-h-screen">
          ...
          <div class="w-[50%] flex-1">
            <img className="max-w-full h-full object-cover" src="/img/cloth2.webp" />
          </div>
        </div>
