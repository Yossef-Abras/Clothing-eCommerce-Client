                  ...
                  <div>
                    ...
                    <p  className="  text-center m-8"  > 
                      Our team is here for you online 24/7. Talk to us about order logistics, outfit inspiration or anything else 
                        ...
                        <div className="bg-[#eee]  rounded-3xl p-2 w-fit my-30 mx-auto md:flex  justify-center my-7     " >
                                  
                                    <div  className="my-40 mx-40 p-15  border-8 border-orange-400 rounded-2xl m-10 p-14 mt-10  md:w-1/2   " style={{margin: " 20px 20px"  }}> 
                                      ...
                                      <strong>EMAIL</strong>
                                        ...
                                        <strong> 
                                          ...
                                          onClick={()=>{alert(`Enter your Email ${<form>
                                            <input type="email"/>
                                    ...
                                    <div  className="my-40 mx-40 p-15 border-8 border-orange-400 rounded-2xl m-10 p-14 md:w-1/2" style={{margin: " 20px 20px"  }}> 
