...
export default function Home() {
  ...
  return (
    <main className={`flex min-h-screen flex-col items-center justify-start`}>
      <div className="md:flex w-full shadow-md ">
        <Card className="w-full flex flex-row justify-around pb-10 rounded-none">
          ...
          <div className="flex gap-16">
            <Image
              ...
              className="self-end w-fit h-64 md:h-80 pb-1 rounded-lg"
            />
            <Image
              width={4000}
              height={3000}
