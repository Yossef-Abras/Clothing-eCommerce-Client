    ...
    >
      <div className="md:flex w-screen shadow-md ">
        <Card className="w-full flex flex-row justify-around pb-10">
          <div className="flex bg-orange-300 rounded-b-full w-24 h-20 justify-center font-bold"><p className="self-center" >Women's</p></div>
          <Image
            width={4000}
            height={3000}
            src="/img/girl.png"
          ...
          />
          <div className="flex bg-orange-300 rounded-b-full w-24 h-20 justify-center font-bold"><p className="self-center">Man</p></div>
        </Card>
